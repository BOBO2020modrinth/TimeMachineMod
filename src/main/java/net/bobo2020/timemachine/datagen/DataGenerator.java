...
@EventBusSubscriber(modid = TimeMachine.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
public class DataGenerator {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new LootTableProvider(packOutput,
                ...
                .SubProviderEntry(ModBlockLootTableProvider::new, LootContextParamSets.BLOCK)), lookupProvider));
